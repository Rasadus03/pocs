...
/*
    usage :  java -cp target com.wavechain.UDPSender 192.168.122.1 45588         (UDP unicast scenario)
             java -cp target com.wavechain.UDPSender 239.9.9.9 45588             (multicast scenario)
 */
